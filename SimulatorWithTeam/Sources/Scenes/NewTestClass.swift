...
//  SimulatorWithTeam
//
//  Created by Роман Глухарев on 22.03.24.
//
...
class TestTestTestClass: UIViewController {
    ...
    private lazy var textwView: UITextView = {
        let text = UITextView()
        return text
    }()
    ...
    private lazy var network1: UIButton = {
        let button = UIButton(type: .system)
        return button
    }()
    
    private lazy var network2: UIButton = {
        let button = UIButton(type: .system)
        return button
    }()
    
    private lazy var network3: UIButton = {
        let button = UIButton(type: .system)
        return button
    }()
    
    private lazy var network4: UIButton = {
        let button = UIButton(type: .system)
        return button
    }()
    ...
    private lazy var network6: UIButton = {
        let button = UIButton(type: .system)
        return button
    }()
}
